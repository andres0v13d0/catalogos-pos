...
export default function QuantitySelector({ value, onChange, className = "" }: QuantitySelectorProps) {
  ...
  const selectClass = `w-full px-3 py-2 border-2 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[var(--color-card-input-focus)] transition-colors bg-white text-gray-800 appearance-none cursor-pointer ${className}`;
